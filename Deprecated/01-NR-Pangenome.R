...
# Author: Greg Poore
# Date: Feb 12, 2024
# Purpose: Analyse rerun Kraken TCGA data
...
# Load count data
countsVb_BIOM <- read_biom(biom_file = "Input_data/HPRC/pangenome-adapter-filter-pese_tcgadb_bac_vir_merged.biom")
...
save(countsVbFinalNonzeroQC,
     ...
     file = paste0("Interim_data/",plotPrefix,"/data_vsnm_tcga_full_and_wis_features_subset_12Feb24.RData"))
