...
## Import data
load("../../Interim_data/Pangenome/data_vsnm_tcga_full_and_wis_features_subset_12Feb24.RData")
load("../../Interim_data/Pangenome/metadata_stage_noMut_subsets_12Feb24.RData")
...
datasetListNames <- c(# Subset genus raw count data
  "vsnmDataGenusKrakenQCFilt",
  "vsnmDataGenusKrakenQCFilt",
...
metadataListNames <- list(# Genus raw
  "metaDataFinalNonzeroQC_WGS",
  "metaDataFinalNonzeroQC_RNA",
...
baseNamePerDatasetResultsFile <- "perfML_Pangenome_Full_WIS_WGSvsRNA_13Feb24"
baseNameAllResultsFile <- "perfML_Pangenome_Full_WIS_WGSvsRNA_ALL_13Feb24"
