...
# Full
vsnmDataGenusKrakenQCFilt_Path <- vsnmDataGenusKrakenQCFilt[rownames(metaDataFinalNonzeroQCPath),]
# WIS
vsnmDataGenusKrakenQCFiltWIS_Path <- vsnmDataGenusKrakenQCFiltWIS[rownames(metaDataFinalNonzeroQCPath),]
...
# MODIFY AS NEEDED
datasetList <- list(
  vsnmDataGenusKrakenQCFilt_Path,
  vsnmDataGenusKrakenQCFiltWIS_Path
  )
...
baseNamePerDatasetResultsFile <- "perfML_Human_HPRC_StageIvsIV_22Feb24"
baseNameAllResultsFile <- "perfML_Human_HPRC_StageIvsIV_ALL_22Feb24"
