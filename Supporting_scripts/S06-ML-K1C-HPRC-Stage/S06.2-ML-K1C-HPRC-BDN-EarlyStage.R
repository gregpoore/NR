...
load("../../Interim_data/K1C-HPRC/metadata_stage_noMut_subsets_22Feb24.RData")

## Subset count tables (b/c output folders are saved based on datasetName)
# Full
vsnmDataGenusKrakenQCFilt_BDN_EarlyStage <- vsnmDataGenusKrakenQCFilt[rownames(metaDataFinalNonzeroQCPath_BDN_EarlyStage),]
vsnmDataGenusKrakenQCFilt_noMutGuardant <- vsnmDataGenusKrakenQCFilt[rownames(metaDataFinalNonzeroQC_noMutGuardant),]
vsnmDataGenusKrakenQCFilt_noMutFoundation <- vsnmDataGenusKrakenQCFilt[rownames(metaDataFinalNonzeroQC_noMutFoundation),]

# WIS
vsnmDataGenusKrakenQCFiltWIS_BDN_EarlyStage <- vsnmDataGenusKrakenQCFiltWIS[rownames(metaDataFinalNonzeroQCPath_BDN_EarlyStage),]
vsnmDataGenusKrakenQCFiltWIS_noMutGuardant <- vsnmDataGenusKrakenQCFiltWIS[rownames(metaDataFinalNonzeroQC_noMutGuardant),]
vsnmDataGenusKrakenQCFiltWIS_noMutFoundation <- vsnmDataGenusKrakenQCFiltWIS[rownames(metaDataFinalNonzeroQC_noMutFoundation),]
...
# MODIFY AS NEEDED
datasetList <- list(
  vsnmDataGenusKrakenQCFilt_BDN_EarlyStage,
  vsnmDataGenusKrakenQCFilt_noMutGuardant,
  vsnmDataGenusKrakenQCFilt_noMutFoundation,
  
  vsnmDataGenusKrakenQCFiltWIS_BDN_EarlyStage,
  vsnmDataGenusKrakenQCFiltWIS_noMutGuardant,
  vsnmDataGenusKrakenQCFiltWIS_noMutFoundation
)
...
baseNamePerDatasetResultsFile <- "perfML_Human_HPRC_BDN_EarlyStage_noMut_22Feb24"
baseNameAllResultsFile <- "perfML_Human_HPRC_BDN_EarlyStage_noMut_ALL_22Feb24"
