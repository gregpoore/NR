...
metadataListNames <- list(
  # BinsWIS data per-center
  "metaDataFinalNonzeroQC_HiSeq_HMS_shuffled",
  "metaDataFinalNonzeroQC_HiSeq_BCM_shuffled",
  "metaDataFinalNonzeroQC_HiSeq_MDA_shuffled",
  "metaDataFinalNonzeroQC_HiSeq_WashU_shuffled",
  "metaDataFinalNonzeroQC_HiSeq_Broad_WGS_shuffled",
  "metaDataFinalNonzeroQC_HiSeq_UNC_shuffled",
  "metaDataFinalNonzeroQC_HiSeq_CMS_shuffled",
  ...
  # VSNM data
  "metaDataFinalNonzeroQC_shuffled",
  "metaDataFinalNonzeroQC_shuffled"
  )

baseNamePerDatasetResultsFile <- "perfML_Human_HPRC_Full_WIS_Bins_Shuffled_22Feb24"
baseNameAllResultsFile <- "perfML_Human_HPRC_Full_WIS_Bins_Shuffled_ALL_22Feb24"
