...
metadataListNames <- list(
  # BinsWIS data per-center
  "metaDataFinalNonzeroQC_HiSeq_HMS_scrambled",
  "metaDataFinalNonzeroQC_HiSeq_BCM_scrambled",
  "metaDataFinalNonzeroQC_HiSeq_MDA_scrambled",
  "metaDataFinalNonzeroQC_HiSeq_WashU_scrambled",
  "metaDataFinalNonzeroQC_HiSeq_Broad_WGS_scrambled",
  "metaDataFinalNonzeroQC_HiSeq_UNC_scrambled",
  "metaDataFinalNonzeroQC_HiSeq_CMS_scrambled",
  ...
  # VSNM data
  "metaDataFinalNonzeroQC_scrambled",
  "metaDataFinalNonzeroQC_scrambled"
)

baseNamePerDatasetResultsFile <- "perfML_Human_HPRC_Full_WIS_Bins_scrambled_22Feb24"
baseNameAllResultsFile <- "perfML_Human_HPRC_Full_WIS_Bins_scrambled_ALL_22Feb24"
  ...
  for(kk in seq_along(sampleTypeList)){
    ...
    for(ii in seq_along(levels(metaTmp2$disease_type))){
      ...
      if(scrambleFlag){
        ...
        set.seed(42)
        trainX_shuffled <- trainX[sample(nrow(trainX)),]
        rownames(trainX_shuffled) <- rownames(trainX)
        trainX <- trainX_shuffled
      }
