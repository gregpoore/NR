...
metaDataFinalNonzeroQC_WGS <- metaDataFinalNonzeroQC %>%
  filter(experimental_strategy == "WGS") %>%
  droplevels()
metaDataFinalNonzeroQC_RNA <- metaDataFinalNonzeroQC %>%
  filter(experimental_strategy == "RNA-Seq") %>%
  droplevels()

# Full
vsnmDataGenusKrakenQCFilt_WGS <- vsnmDataGenusKrakenQCFilt[rownames(metaDataFinalNonzeroQC_WGS),]
vsnmDataGenusKrakenQCFilt_RNA <- vsnmDataGenusKrakenQCFilt[rownames(metaDataFinalNonzeroQC_RNA),]

# WIS
vsnmDataGenusKrakenQCFiltWIS_WGS <- vsnmDataGenusKrakenQCFiltWIS[rownames(metaDataFinalNonzeroQC_WGS),]
vsnmDataGenusKrakenQCFiltWIS_RNA <- vsnmDataGenusKrakenQCFiltWIS[rownames(metaDataFinalNonzeroQC_RNA),]
...
datasetList <- list(
  # WIS
  vsnmDataGenusKrakenQCFiltWIS_WGS,
  vsnmDataGenusKrakenQCFiltWIS_RNA,
  # Full
  vsnmDataGenusKrakenQCFilt_WGS,
  vsnmDataGenusKrakenQCFilt_RNA
)
...
metadataList <- list(
  metaDataFinalNonzeroQC_WGS,
  metaDataFinalNonzeroQC_RNA,
...
baseNamePerDatasetResultsFile <- "perfML_Human_HPRC_WGSvsRNA_22Feb24"
baseNameAllResultsFile <- "perfML_Human_HPRC_WGSvsRNA_ALL_22Feb24"
